...
function DeleteModal(props){
    ...
    const handleOk = () => {
      props.setState({ ...props.state, loading: !props.state.loading })
        ...
        setTimeout(() => {
            props.setState({ ...props.state, visible: !props.state.visible, loading: !props.state.loading, visible: !props.state.visible })
        }, 500)
  }
  ...
  const handleCancel = () => {
    ...
    const changeHandler = (e) => { 
        setToDelete({...toDelete, ...validateIt(e.target.value), value: e.target.value, })
    }
    console.log(toDelete)
     const tips = "Please type in the name of the Type that you would like to delete"
        return (
          <div className="modal">
            <Modal
              width="400px"
            ...
            >
              ...
              <h3>
                All Records, Fields, and Media will be deleted along with this
                type. All data will be lost.
              </h3>
